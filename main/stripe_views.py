...
def subscription_plans(request):
    ...
    return render(
        ...
        {"plans": plans, "stripe_public_key": settings.STRIPE_PUBLIC_KEY},
    )
...
def subscription_success(request):
    ...
    try:
        ...
        return render(
            request, "subscription_success.html", {"subscription": subscription}
        )
...
def manage_subscription(request):
    ...
    try:
        ...
        return render(
            ...
            {"subscription": subscription, "subscription_data": subscription_data},
        )
