...
urlpatterns = [
    ...
    path('subscriptions/create/<slug:plan_slug>/<str:interval>/', 
         stripe_views.create_checkout_session, name='create_checkout_session'),
    path('subscriptions/success/', stripe_views.subscription_success, name='subscription_success'),
    path('subscriptions/manage/', stripe_views.manage_subscription, name='manage_subscription'),
    ...
    path('post/<uuid:uuid>/purchase/confirm/', views.post_purchase_confirm, name='post_purchase_confirm'),
    path('post/<uuid:uuid>/access-check/', views.post_access_check, name='post_access_check'),
